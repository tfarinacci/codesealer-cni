	...
	cases := []testCase{
		{
			...
			expectedOutputFile:     testDataDir + "/expected/10-calico.conflist-codesealerconfig",
		...
		},
		{
			...
			resultFileName:     "YYY-codesealer-cni.conf",
			expectedOutputFile: testDataDir + "/expected/YYY-codesealer-cni.conf",
		},
		{
